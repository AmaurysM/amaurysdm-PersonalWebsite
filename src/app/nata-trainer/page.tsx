    ...
    return (
        <main className="relative bg-slate-950/60 text-slate-100 overflow-hidden">
            ...
            <div className="flex items-center text-sm font-medium text-slate-200 bg-slate-800/50 border border-slate-700/50">
                ...
                <div className="px-4">Line Trainer</div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="space-y-4">
                            <div className="bg-slate-900/50 border border-slate-700/50 p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <h3 className="text-sm font-semibold text-slate-400 uppercase mb-1">Overall Progress</h3>
                            ...
                            <div className="bg-slate-900/50 border border-slate-700/50 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-sm font-semibold text-slate-400 uppercase mb-1">Tasks Completed</h3>
                            ...
                            <div className="bg-slate-900/50 border border-slate-700/50 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-sm font-semibold text-slate-400 uppercase mb-1">Needs Attention</h3>
                        ...
                        <div className="bg-slate-900/50 border border-slate-700/50 p-6">
                            <h3 className="text-sm font-semibold text-white mb-4">Student Progress (24)</h3>
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={student.name} className="bg-slate-800/50 border border-slate-700/50 p-3">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-sm font-medium text-white">{student.name}</span>
                                            <span className={`text-xs px-2 py-0.5 rounded ${student.status === 'completed' ? 'bg-green-500/20 text-green-400' :
                                        ...
                                        <div className="w-full bg-slate-700 h-1.5 rounded-full">
                                            <div
                                                className={`h-1.5 rounded-full ${student.progress >= 75 ? 'bg-green-500' :
                    ...
                    <div className="bg-slate-900/50 border border-slate-700/50 p-6">
                        <h3 className="text-sm font-semibold text-white mb-4">Submodule Completion Rates</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {[
                                ...
                                <div key={sub.code} className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        <span className="text-xs font-medium text-blue-400">{sub.code}</span>
                                        <span className={`text-xs font-semibold ${sub.rate >= 75 ? 'text-green-400' :
                                    ...
                                    <div className="w-full bg-slate-800 h-1.5 rounded-full">
                                        <div
                                            className={`h-1.5 rounded-full ${sub.rate >= 75 ? 'bg-green-500' :
                ...
                <div className="max-w-7xl mx-auto px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-3">
                            {/* Progress Bar Card */}
                            <div className="bg-slate-900/50 border border-slate-700/50 p-6 mb-6">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <h3 className="text-base font-semibold text-white">Module Progress</h3>
                                        <p className="text-sm text-slate-400 mt-0.5">6 of 8 submodules completed</p>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-3xl font-semibold text-white">75%</div>
                                    </div>
                                </div>
                                <div className="w-full bg-slate-800 h-2 rounded-full">
                            ...
                            {submodules.map((sub) => {
                                ...
                                return (
                                    <div
                                        key={sub._id}
                                        className="bg-slate-900/50 border border-slate-700/50 p-4 hover:border-slate-600/50 transition-colors"
                                    >
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex flex-wrap items-center gap-2">
                                                    <span
                                                        className={`text-xs px-2 py-0.5 font-medium rounded ${progress.completed
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        {Array.from({ length: sub.requiredSignatures }).map((_, i) => (
                                                            <div
                                                                key={i}
                                                                className={`w-6 h-6 flex items-center justify-center rounded text-xs ${i < progress.signatures
                                                                        ? "bg-green-500/20 text-green-400"
                        ...
                        <div className="space-y-4">
                            {/* Overview Stats */}
                            <div className="bg-slate-900/50 border border-slate-700/50 p-4">
                            ...
                            {/* Student Info */}
                            <div className="bg-slate-900/50 border border-slate-700/50 p-4">
                                <h3 className="text-sm font-semibold text-white mb-3">Student</h3>
                                <div className="space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-slate-400">sarah.j@aviation.com</div>
                                    </div>
                                    <div>
                ...
                <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative">
                        <div className="relative border border-slate-700/50 bg-slate-900/50 backdrop-blur-sm shadow-xl overflow-hidden p-8">
                            {/* Role visualization */}
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 p-4 bg-green-500/10 border border-green-500/20">
                                    <div className="h-12 w-12 bg-green-500 rounded-full flex items-center justify-center text-white font-bold">
                                        S
                                    </div>
                                    <div>
                                        <div className="font-semibold text-white">Student</div>
                                        <div className="text-xs text-slate-400">Complete training modules</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 p-4 bg-blue-500/10 border border-blue-500/20">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-400">Verify and sign off progress</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 p-4 bg-purple-500/10 border border-purple-500/20">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-400">Manage organization</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative border border-slate-700/50 bg-slate-900/50 backdrop-blur-sm shadow-xl overflow-hidden p-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="text-xs text-slate-500 mt-1">6 of 8 submodules complete</div>
                                </div>
                                <div>
                                    <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <div className="text-xs text-slate-500 mt-1">3 of 6 submodules complete</div>
                                </div>
                                <div>
                                    <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <div className="text-xs text-slate-500 mt-1">2 of 8 submodules complete</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative min-h-screen flex items-center justify-center px-6 py-32">
                <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative border border-white/10 backdrop-blur-sm overflow-hidden bg-slate-900/50 p-8">
                        {/* Dashboard preview */}
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <div className="bg-slate-800/50 border border-slate-700/50 p-4">
                                <div className="text-xs text-slate-400 uppercase mb-1">Total Users</div>
                                <div className="text-3xl font-bold text-white">47</div>
                                <div className="text-xs text-green-400 mt-1">+3 this week</div>
                            </div>
                            <div className="bg-slate-800/50 border border-slate-700/50 p-4">
                                <div className="text-xs text-slate-400 uppercase mb-1">Modules</div>
                                <div className="text-3xl font-bold text-white">12</div>
                                <div className="text-xs text-slate-400 mt-1">84 submodules</div>
                            </div>
                            <div className="bg-slate-800/50 border border-slate-700/50 p-4">
                                <div className="text-xs text-slate-400 uppercase mb-1">Signatures</div>
                                <div className="text-3xl font-bold text-white">328</div>
                                <div className="text-xs text-slate-400 mt-1">21 in last 7 days</div>
                            </div>
                            <div className="bg-slate-800/50 border border-slate-700/50 p-4">
                                <div className="text-xs text-slate-400 uppercase mb-1">Active Users</div>
                                <div className="text-3xl font-bold text-white">38</div>
                                <div className="text-xs text-slate-400 mt-1">81% of total</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer className="py-12 border-t border-slate-800/50">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h3 className="text-2xl font-bold text-white mb-1">Line Trainer</h3>
                            <p className="text-sm text-slate-400">
